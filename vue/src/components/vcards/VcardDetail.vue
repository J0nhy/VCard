    ...
    <div class="d-flex flex-wrap justify-content-between">
      <div class="w-75 pe-4">
        ...
        <div class="mb-3 px-1">
          ...
          <input type="text" class="form-control" :class="{ 'is-invalid': errors ? errors['balance'] : false }"
            id="inputBalance" placeholder="Balance" required v-model="editingVcard.balance" />
        ...
        <div class="mb-3 px-1">
          ...
          <input type="text" class="form-control" :class="{ 'is-invalid': errors ? errors['max_debit'] : false }"
            id="inputMaxDebit" placeholder="max_debit" required v-model="editingVcard.max_debit" />
